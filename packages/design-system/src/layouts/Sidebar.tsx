...
export default function Sidebar() {
  ...
  return (
    <nav className='border-white-300 px-28 py-20'>
      <input
        className='border-white-300 focus:border-black-200 w-full rounded-lg border px-8 py-4 text-sm focus:outline-0'
        placeholder='Search'
        type='text'
        value={query}
